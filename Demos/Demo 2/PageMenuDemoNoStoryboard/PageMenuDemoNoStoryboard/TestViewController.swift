...
class TestViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        pageMenu = CAPSPageMenu(viewControllers: controllerArray, frame: CGRectMake(0.0, 50.0, self.view.frame.width, 300), pageMenuOptions: nil)
        ...
        // Initialize scroll menu
        pageMenu1 = CAPSPageMenu(viewControllers: controllerArray_1, frame: CGRectMake(0.0, 400.0, self.view.frame.width, 300.0), pageMenuOptions: nil)
