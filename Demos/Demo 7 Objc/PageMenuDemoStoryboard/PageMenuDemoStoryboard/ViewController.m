...
- (void)viewDidLoad {
    ...
    TestViewController *controller5 = [[TestViewController alloc] initWithNibName:@"TestViewController" bundle:nil];
    controller5.title = @"CAT";
    TestViewController *controller6 = [[TestViewController alloc] initWithNibName:@"TestViewController" bundle:nil];
    controller6.title = @"DOG";
    TestViewController *controller7 = [[TestViewController alloc] initWithNibName:@"TestViewController" bundle:nil];
    controller7.title = @"CENTERMENUSCROLLVIEW";
    TestViewController *controller8 = [[TestViewController alloc] initWithNibName:@"TestViewController" bundle:nil];
    controller8.title = @"HOWTOTOTO";
    TestViewController *controller9 = [[TestViewController alloc] initWithNibName:@"TestViewController" bundle:nil];
    controller9.title = @"ITEMS";
    

    NSArray *controllerArray = @[controller1, controller2, controller3, controller4, controller5, controller6, controller7, controller8, controller9];
    NSDictionary *parameters = @{
                                 ...
                                 CAPSPageMenuOptionCenterMenuScrollView: @(YES),
                                 };
